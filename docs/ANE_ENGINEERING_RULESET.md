...
|---|---|---|
| **32MB on-chip SRAM working-set budget** | Exceeding it spills to DRAM → ~30% throughput drop | ✅ PDF pages processed **sequentially**; render artifacts freed per page via `autoreleasepool` |
...
| `ANE_SRAM_BYTES` | `33_554_432` (32MB) | Working-set budget |
| `OCR_CONCURRENCY_CEILING` | `4` | `OCRService.clampedConcurrency` |
